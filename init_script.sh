...
turn:
    enabled: true
    domain: livekit-turn.ecommcube.com
    tls_port: 5349
    udp_port: 3478
    external_tls: true
ingress:
    rtmp_base_url: rtmp://livekit.ecommcube.com:1935/x
    whip_base_url: https://livekit-whip.ecommcube.com/w
keys:
    APILodLwqNKJYqE: TIbzUfLfcCd6KZjZlGgbxnKqTsHBy7zDe5bzDe9gg3UB
...
apps:
  tls:
    certificates:
      automate:
        - livekit.ecommcube.com
        - livekit-turn.ecommcube.com
        - livekit-whip.ecommcube.com
  layer4:
    servers:
      main:
        listen: [":443"]
...
ws_url: wss://livekit.ecommcube.com
